...
public final class QueryUtils {
    ...
    public static String makeHttpRequest(String stringUrl) {
    ...
    public static ArrayList<QuakeInfo> fetchQuakesInfo(String stringUrl) {
        String jsonResponse;

        jsonResponse = makeHttpRequest(stringUrl);

        return extractQuakesInfoFromJson(jsonResponse);
     ...
     */
    public static ArrayList<QuakeInfo> extractQuakesInfoFromJson(String jsonResponse) {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<QuakeInfo> quakesInfo = new ArrayList<>();
        ...
        try {
            ...
            // build up a list of QuakeInfo objects with the corresponding data.
            JSONObject quakesJSON = new JSONObject(jsonResponse);
            JSONArray features = quakesJSON.getJSONArray("features");
            for(int i = 0; i < features.length(); ++i) {
                ...
                quakesInfo.add(new QuakeInfo(place, magnitude, date, url));
            }
